...
export function TopNav({ title = "Dashboard Overview" }: { title?: string }) {
  return (
    <header className="h-16 border-b border-gray-200 dark:border-white/10 bg-white dark:bg-sidebar-dark px-8 flex items-center justify-between sticky top-0 z-10">
      <div className="flex items-center gap-4">
        ...
        <div className="flex items-center gap-4 text-sm font-medium text-gray-500 dark:text-gray-400">
          <a className="text-primary border-b-2 border-primary py-5" href="#">Overview</a>
          <a className="hover:text-primary transition-colors py-5" href="#">Analytics</a>
          <a className="hover:text-primary transition-colors py-5" href="#">Reports</a>
        </div>
      </div>
      <div className="flex items-center gap-4">
